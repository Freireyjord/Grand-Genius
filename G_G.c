...
#define LEDy BIT0    // define o pino de saída do LED como P1.0
#define LEDr BIT1    // define o pino de saída do LED como P1.0
#define LEDb BIT2    // define o pino de saída do LED como P1.0
#define LEDg BIT3    // define o pino de saída do LED como P1.0

#define BUTy BIT5    // define o pino de saída do LED como P1.4
#define BUTb BIT4    // define o pino de saída do LED como P1.4
#define BUTr BIT1    // define o pino de saída do LED como P1.4
#define BUTg BIT0    // define o pino de saída do LED como P1.4
